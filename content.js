...
function modAnchor(e){
	...
	if(s.indexOf('29963')>=0){e.style.display="none";return;}
	if(s.indexOf('12227')>=0){e.style.display="none";return;}
...
function revAnchor(e){
	...
	if(s.indexOf('29963')>=0){e.style.display="";return;}
	if(s.indexOf('12227')>=0){e.style.display="";return;}
